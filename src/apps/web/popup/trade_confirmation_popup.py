...
class TradeConfirmationPopup:
    ...
    __btn_confirm = (By.CSS_SELECTOR, "button[data-testid$='confirmation-button-confirm']")
    ...
    __lbl_confirmation_value_list = (By.CSS_SELECTOR, "div[data-testid$='confirmation-value'")
    ...
    def get_confirmation_order_info(self, is_volume_size=False) -> list:
        ...
        pop_index = 2 if is_volume_size else 1
